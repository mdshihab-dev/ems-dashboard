    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6 max-w-3xl animate-fade-in">
            ...
            <div className="card p-5 sm:p-6">
                <h3 className="font-medium mb-6 pb-4 border-b border-gray-200">Personal Information</h3>
            ...
            {/* =========== Employment Details =========== */}
            <div className="card p-5 sm:p-6">
                <h3 className="text-base font-medium text-gray-900 mb-6 pb-4 border-b border-gray-200">Employment Details</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-gray-700">
                    <div>
            ...
            {/* =========== Account Setup =========== */}
            <div className="card p-5 sm:p-6">
                <h3 className="text-base font-medium mb-6 pb-4 border-b border-gray-200">Account Setup</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-gray-700">
                    <div className="sm:col-span-2">
